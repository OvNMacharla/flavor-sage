...
function Recipe() {
  ...
  try {
    ...
    let promt = ' '
    if (answers[3] === 'Yes') {
      promt = 'I am a '+ answers[0] +". Generate a recipe with spieciness of "+answers[1]+' And extra ingredients' + + ' Within '+answers[2]+" Frame that answer in a table with starting ingredients then instruction"
    } else {
      promt = 'I am a '+ answers[0] +". Generate a recipe with spieciness of "+answers[1]+ ' Within '+answers[2]+" Frame that answer in a table with starting ingredients then instruction"
    }
    ...
    <div>
        ...
        <main className="" id="main-collapse">
          ...
          <div style={{display: 'contents'}}>
              ...
              <div className="section-container-spacer">
                <p><img className="img-responsive" alt="" src={img12}/></p>
              </div>
              <div id='loader' style={{justifyContent:'center',height:'5rem'}}>
