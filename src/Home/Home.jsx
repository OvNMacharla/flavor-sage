...
function Home() {
  ...
  const questions = [
    ...
    {
      question:
        'Are there any specific ingredients you want to include or avoid?',
      options: ['Yes', 'No'],
    },
  ]
        ...
        <div className="hero-full-wrapper">
          ...
          <div className="grid">
            ...
            <h1 style={{ fontSize: '17px', fontWeight: '500' }}>
              Explore a curated selection of delicious recipes handpicked just
              for you. Whether you're looking for a quick weeknight meal or a
              special dish for a celebration, we've got you covered. Discover
              new flavors and cooking inspiration with our personalized recipe
              recommendations
            </h1>
            ...
            <h4 style={{ fontSize: '17px', fontWeight: '500' }}>
              Ready for more culinary inspiration? Simply ask to see more
              delicious recipes and unlock a world of flavors waiting to be
              explored. Your next great meal is just a click away
            </h4>
          </div>
