          ...
          <div className="row">
            <div className="col-xs-12">
              <div className="section-container-spacer">
                ...
                <h3>Contact Us</h3>
                <p>
                  Thank you for your interest in reaching out to us. Your
                  feedback, inquiries, and suggestions are invaluable to us as
                  we strive to improve and provide the best possible experience
                  for our visitors and customers. Please feel free to connect
                  with us using any of the contact methods below.
                </p>
              </div>
              <div className="section-container-spacer">
                <form action="" className="reveal-content" onSubmit={onSubmit}>
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <a
                        target="_blank"
                        href="https://www.linkedin.com/in/ome-venkata-nagarjuna?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                        title=""
                        className="fa-icon"
                        rel="noreferrer"
                      >
                ...
                <div className="login-main-container">
                  <div className="thankyou-wrapper">
                    ...
                    <p>
                      ...
                      valuable feedback. Your input helps us improve our
                      services and ensure that we continue to meet your needs
                      and preferences..{' '}
                    </p>
